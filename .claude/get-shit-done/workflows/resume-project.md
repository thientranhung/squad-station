...
<required_reading>
@/Users/tranthien/Documents/2.DEV/2.PRIVATE/squad-station/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/tranthien/Documents/2.DEV/2.PRIVATE/squad-station/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
