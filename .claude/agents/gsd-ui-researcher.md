...
Use template from `/Users/tranthien/Documents/2.DEV/2.PRIVATE/squad-station/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/tranthien/Documents/2.DEV/2.PRIVATE/squad-station/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/tranthien/Documents/2.DEV/2.PRIVATE/squad-station/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
